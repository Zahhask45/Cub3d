...
/*   Updated: 2023/09/20 18:04:17 by jodos-sa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_img(t_map *map)
{
	...
	i = 0;
	map->img[0].path = "../textures/east.xpm";
	map->img[1].path = "../textures/north.xpm";
	map->img[2].path = "../textures/south.xpm";
	map->img[3].path = "../textures/west.xpm";
	while (1 < 4)
	{
...
int	render(t_map *map)
{
	...
	while (x < WIDTH)
	{
		...
		{
			if (y < HEIGHT / 2)
				put_image(map, x, y, create_trgb(0, map->rgb_ceil[0],
						map->rgb_ceil[1], map->rgb_ceil[2]));
			else
				put_image(map, x, y, create_trgb(0, map->rgb_floor[0],
